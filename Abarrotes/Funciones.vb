Module Funciones
    ...
    'Validar_NombreNumero
    Function Validar_NombreNumero(ByVal e As KeyPressEventArgs, ByVal Cadena As String) As KeyPressEventArgs

        If Char.IsLetter(e.KeyChar) Or e.KeyChar = Chr(8) Or e.KeyChar = Chr(32) Or e.KeyChar = Chr(46) Or Char.IsNumber(e.KeyChar) Then
            If Cadena.Length = 0 And Char.IsLetter(e.KeyChar) Then
                e.KeyChar = Char.ToUpper(e.KeyChar)
            ElseIf Cadena.Length < 3 And e.KeyChar = Chr(32) Then
                e.Handled = True
